...
def test_create_car_success(client, auth_headers, brand, user):
    car_data = {
        'model': 'Corolla',
        'factory_year': 2023,
        'model_year': 2023,
...
def test_create_car_without_description(client, auth_headers, brand, user):
    car_data = {
        'model': 'Civic',
        'factory_year': 2022,
        'model_year': 2022,
...
def test_create_car_duplicate_plate(client, auth_headers, brand, car, user):
    car_data = {
        'model': 'Civic',
        'factory_year': 2022,
        'model_year': 2022,
...
def test_create_car_invalid_brand(client, auth_headers, user):
    car_data = {
        'model': 'Civic',
        'factory_year': 2022,
        'model_year': 2022,
...
def test_create_car_invalid_fuel_type(client, auth_headers, brand, user):
    car_data = {
        'model': 'Civic',
        'factory_year': 2022,
        'model_year': 2022,
...
def test_create_car_invalid_transmission(client, auth_headers, brand, user):
    car_data = {
        'model': 'Civic',
        'factory_year': 2022,
        'model_year': 2022,
...
def test_create_car_negative_price(client, auth_headers, brand, user):
    car_data = {
        'model': 'Civic',
        'factory_year': 2022,
        'model_year': 2022,
...
def test_create_car_unauthorized(client, brand, user):
    car_data = {
        'model': 'Civic',
        'factory_year': 2022,
        'model_year': 2022,
...
def test_create_car_all_fuel_types(client, auth_headers, brand, user):
    fuel_types = [
        'gasoline',
        'ethanol',
        'flex',
...
def test_create_car_all_transmission_types(client, auth_headers, brand, user):
    transmissions = [
...
def test_create_car_duplicate_plate_error(client, auth_headers, brand, user):
    car_data = {
        'model': 'First Car',
        'factory_year': 2023,
        'model_year': 2023,
...
def test_create_car_brand_not_found_error(client, auth_headers, user):
    car_data = {
        'model': 'Test Car',
        'factory_year': 2023,
        'model_year': 2023,
...
def test_create_car_full_creation_flow(client, auth_headers, brand, user):
    car_data = {
...
def test_update_car_plate_conflict_error(client, auth_headers, brand, user):
    car_data_1 = {
        'model': 'Car One',
        'factory_year': 2023,
        'model_year': 2023,
...
def test_create_car_model_too_short_validation(
    client, auth_headers, brand, user
):
    car_data = {
        'model': 'A',
        'factory_year': 2023,
...
def test_create_car_color_too_short_validation(
    client, auth_headers, brand, user
):
    car_data = {
        'model': 'Valid Model',
...
def test_create_car_plate_too_short_validation(
    client, auth_headers, brand, user
):
    car_data = {
        'model': 'Valid Model',
...
def test_create_car_plate_too_long_validation(
    client, auth_headers, brand, user
):
    car_data = {
        'model': 'Valid Model',
...
def test_create_car_model_year_too_new_validation(
    client, auth_headers, brand, user
):
    car_data = {
        'model': 'Valid Model',
...
def test_create_car_negative_price_validation(
    client, auth_headers, brand, user
):
    car_data = {
        'model': 'Valid Model',
...
def test_create_car_zero_price_validation(client, auth_headers, brand, user):
    car_data = {
        'model': 'Valid Model',
        'factory_year': 2023,
        'model_year': 2023,
